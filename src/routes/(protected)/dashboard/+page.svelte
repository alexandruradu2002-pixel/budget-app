...
<WorkInProgress>
	<a
		href="/settings"
		class="px-6 py-3 bg-(--color-primary) hover:bg-(--color-primary-hover) text-(--color-text-primary) rounded-lg font-medium transition-colors flex items-center gap-2"
	>
