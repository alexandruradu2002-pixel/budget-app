...
- [Budget App - Installation Guide](#budget-app---installation-guide)
  ...
  - [Configurare Avansată](#configurare-avansată)
    - [Autentificare](#autentificare)
      - [🔐 Opțiunea A: Email Magic Link + OTP (Recomandat pentru hosted instances)](#-opțiunea-a-email-magic-link--otp-recomandat-pentru-hosted-instances)
      - [🔑 Opțiunea B: Parolă (Pentru self-host privat)](#-opțiunea-b-parolă-pentru-self-host-privat)
      - [Care metodă să aleg?](#care-metodă-să-aleg)
